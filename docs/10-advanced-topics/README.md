...
```mermaid
graph TB
    subgraph 前序章节基础["前序章节基础"]
        Agent层["Agent 层<br/>Agent Loop<br/>事件系统"]
        AI层["AI 层<br/>Provider<br/>Model 接口"]
        工具层["工具层<br/>ToolRegistry<br/>内置工具"]
    end

    扩展系统["扩展系统 (Extension)<br/>ExtensionAPI │ ExtensionLoader │ ExtensionManifest"]
    ...
    测试体系["测试体系<br/>单元测试 │ 集成测试 │ Mock 策略 │ CI 流程"]
