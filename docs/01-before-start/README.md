...
> 在开始学习 piagent 之前，你需要先了解：什么是 AI Coding Agent？如何搭建开发环境？项目结构长什么样？
...
- 熟悉 piagent 的项目结构，知道每个目录和关键文件的职责
- 能够成功运行第一个对话，验证环境正确性
...
- piagent 使用 6 层分层架构，每层职责清晰、可独立测试
...
3. 如果让你给 piagent 加一个新功能（比如"自动提交代码"），你会放在哪一层？
